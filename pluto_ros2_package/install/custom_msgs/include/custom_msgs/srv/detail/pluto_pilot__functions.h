...
#ifndef CUSTOM_MSGS__SRV__DETAIL__PLUTO_PILOT__FUNCTIONS_H_
#define CUSTOM_MSGS__SRV__DETAIL__PLUTO_PILOT__FUNCTIONS_H_
...
/// Initialize srv/PlutoPilot message.
/**
...
/// Finalize srv/PlutoPilot message.
/**
...
/// Create srv/PlutoPilot message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs__srv__PlutoPilot_Request__init().
...
/// Destroy srv/PlutoPilot message.
/**
 * It calls
 * custom_msgs__srv__PlutoPilot_Request__fini()
...
/// Check for srv/PlutoPilot message equality.
/**
...
/// Initialize array of srv/PlutoPilot messages.
/**
...
/// Finalize array of srv/PlutoPilot messages.
/**
 * It calls
 * custom_msgs__srv__PlutoPilot_Request__fini()
...
/// Create array of srv/PlutoPilot messages.
/**
 * It allocates the memory for the array and calls
 * custom_msgs__srv__PlutoPilot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlutoPilot messages.
/**
 * It calls
 * custom_msgs__srv__PlutoPilot_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlutoPilot message array equality.
/**
...
/// Copy an array of srv/PlutoPilot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs__srv__PlutoPilot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It calls
 * custom_msgs__srv__PlutoPilot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * custom_msgs__srv__PlutoPilot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It calls
 * custom_msgs__srv__PlutoPilot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_MSGS__SRV__DETAIL__PLUTO_PILOT__FUNCTIONS_H_
